...
public class OMPParser extends Parser {
	...
	public static final int
		...
		RULE_ompAtomic = 13, RULE_ompCritical = 14, RULE_ompThreadNum = 15, RULE_ompNumThreads = 16, 
		RULE_ompSchedule = 17, RULE_threadNum = 18, RULE_ompAccessModifier = 19, 
		RULE_ompVars = 20, RULE_ompVar = 21, RULE_ompNumber = 22;
	public static final String[] ruleNames = {
		...
		"ompAtomic", "ompCritical", "ompThreadNum", "ompNumThreads", "ompSchedule", 
	...
	public final OmpUnitContext ompUnit() throws RecognitionException {
		...
		try {
			...
			{
			setState(46); match(OMP);
			setState(59);
			switch ( getInterpreter().adaptivePredict(_input,0,_ctx) ) {
			case 1:
				{
				setState(47); ompParallel();
				}
				break;
			case 2:
				{
				setState(48); ompParallelFor();
				}
				break;
			case 3:
				{
			...
			case 4:
				{
				setState(50); ompSections();
				}
				break;
			case 5:
				{
				setState(51); ompSection();
				}
				break;
			case 6:
				{
				setState(52); ompSingle();
				}
				break;
			case 7:
				{
				setState(53); ompMaster();
				}
				break;
			case 8:
				{
				setState(54); ompBarrier();
				}
				break;
			case 9:
				{
				setState(55); ompAtomic();
				}
				break;
			case 10:
				{
				setState(56); ompCritical();
				}
				break;
			case 11:
				{
				setState(57); ompThreadNum();
				}
				break;
			case 12:
				{
				setState(58); ompNumThreads();
				}
				break;
			}
	...
	public final OmpParallelContext ompParallel() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(63); match(PARALLEL);
			setState(64); ompParallelModifiers();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OmpParallelModifiersContext ompParallelModifiers() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(66); ompParallelModifier();
				setState(67); ompParallelModifiers();
				}
				break;
			case 2:
	...
	public final OmpParallelForContext ompParallelFor() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(83); match(PARALLEL);
			setState(84); match(FOR);
			setState(85); ompParallelForModifiers();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OmpParallelForModifiersContext ompParallelForModifiers() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(88); ompParallelForModifier();
	...
	public final OmpParallelForModifierContext ompParallelForModifier() throws RecognitionException {
		...
		try {
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(102); ompAccessModifier();
				}
				break;
			}
		}
	...
	public final OmpSectionsContext ompSections() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(112); match(SECTIONS);
			setState(114);
			_la = _input.LA(1);
			if (_la==SCHEDULE) {
				{
				setState(113); ompSchedule();
				}
			}
	...
	public final OmpThreadNumContext ompThreadNum() throws RecognitionException {
		...
		enterRule(_localctx, 30, RULE_ompThreadNum);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(133); match(OMPTHREADNUM);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OmpNumThreadsContext ompNumThreads() throws RecognitionException {
		...
		enterRule(_localctx, 32, RULE_ompNumThreads);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(135); match(OMPNUMTHREADS);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OmpScheduleContext ompSchedule() throws RecognitionException {
		...
		enterRule(_localctx, 34, RULE_ompSchedule);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(137); match(SCHEDULE);
	...
	public final ThreadNumContext threadNum() throws RecognitionException {
		...
		enterRule(_localctx, 36, RULE_threadNum);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(142); match(THREAD_NUM);
			setState(143); match(T__2);
			setState(144); ompNumber();
	...
	public final OmpAccessModifierContext ompAccessModifier() throws RecognitionException {
		...
		enterRule(_localctx, 38, RULE_ompAccessModifier);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final OmpVarsContext ompVars() throws RecognitionException {
		...
		enterRule(_localctx, 40, RULE_ompVars);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public final OmpVarContext ompVar() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_ompVar);
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final OmpNumberContext ompNumber() throws RecognitionException {
		...
		enterRule(_localctx, 44, RULE_ompNumber);
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static final String _serializedATN =
		...
		"\5\3\6\3\6\3\6\3\6\3\7\3\7\3\7\3\7\3\7\5\7_\n\7\3\b\3\b\3\b\3\b\3\b\3"+
		"\b\3\b\3\b\3\b\5\bj\n\b\3\t\3\t\7\tn\n\t\f\t\16\tq\13\t\3\n\3\n\5\nu\n"+
		"\n\3\13\3\13\3\f\3\f\3\r\3\r\3\16\3\16\3\17\3\17\3\20\3\20\3\20\3\20\3"+
		"\20\5\20\u0086\n\20\3\21\3\21\3\22\3\22\3\23\3\23\3\23\3\23\3\23\3\24"+
		"\3\24\3\24\3\24\3\24\3\25\3\25\3\25\3\25\3\25\3\26\3\26\3\26\3\26\6\26"+
		"\u009f\n\26\r\26\16\26\u00a0\3\26\3\26\5\26\u00a5\n\26\3\27\3\27\3\30"+
		"\3\30\3\30\2\2\31\2\4\6\b\n\f\16\20\22\24\26\30\32\34\36 \"$&(*,.