...
public interface Java8Visitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link Java8Parser#ompNumThreads}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOmpNumThreads(@NotNull Java8Parser.OmpNumThreadsContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link Java8Parser#ompThreadNum}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOmpThreadNum(@NotNull Java8Parser.OmpThreadNumContext ctx);
	/**
